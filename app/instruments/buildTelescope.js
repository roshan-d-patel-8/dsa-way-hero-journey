...
// The approved telescope geometry, now lit and projected by the shared chamber scene.
export function buildTelescope(scene) {
  ...
  model.traverse(object => {
    if (object.material?.isMeshStandardMaterial) {
      object.material.metalness = .48;
      object.material.roughness = .64;
    }
  });
  return { model, optical, textures: [grain, labelTexture] };
}
