...
export const REMAINING_CHAMBER_SPECS: Record<RemainingBoxNumber, RemainingChamberSpec> = {
    ...
    trials: [
      {
        ...
        options: [
          ...
          "By December 15, raise readiness-check completion five days before procedures from 58 to at least 90 percent.",
      ...
      },
      {
        ...
        correct: 0,
        answer: "STAR FIXED: an observer can see whether the checklist is complete on time. The team can still choose how to achieve that.",
        wrong: {
      ...
      },
      {
        ...
        glyph: "✦",
        name: "Arrival Test",
        clue: "Check that the improved results last beyond one lucky week",
        ...
        correct: 1,
        answer: "CONSTELLATION COMPLETE: fewer cancellations, consistent checklist use, and unchanged after-hours work show the full goal is being met.",
        wrong: {
  ...
  5: {
    ...
    prologue: [
      "Forty-two pathology results waited more than three days last month. Direct observation of the work found that every result reached the correct Health Connect inbox, but the inbox flags only what is new—not what is becoming old. Staff manually sort the list when someone remembers.",
  ...
  8: {
    ...
    prologue: [
      ...
      "There is a complication: inbound patient messages rose 22%. Hear the witnesses for results, new work steps, and possible unintended effects before the tribunal decides whether the full improvement is confirmed.",
    ],
    ...
    completionLead: "The results and checklist use met their goals. More patient messages need investigation before the team can judge the full improvement.",
    ...
    trials: [
      {
        ...
        prompt: "What do the cancellation results allow the team to say?",
        ...
        correct: 0,
        answer: "TESTIMONY ACCEPTED: cancellations met the agreed goal for the required eight weeks.",
        wrong: {
      ...
      },
      {
        ...
        prompt: "Does the checklist evidence show that the new steps happened as planned?",
        coaching: "How consistently was the five-day readiness check completed?",
        options: [
          "The new steps met their goal: 92 percent completed the five-day check, above the 90 percent target.",
          "The reminder is proven to cause fewer cancellations because cancellations fell after the texts were launched.",
          "The new steps failed because eight percent of patients still lacked completed checks during the review.",
        ],
        correct: 0,
        answer: "TESTIMONY ACCEPTED: checklist completion exceeded the 90 percent goal agreed before the test. It does not prove what caused fewer cancellations.",
        wrong: {
          1: "A result improving after a change does not by itself prove cause. Checklist completion tells us whether the new steps happened.",
      ...
      },
      {
        ...
        prompt: "What does the rise in patient messages mean for the decision about success?",
        coaching: "Why did messages increase, and what does that mean for patients and staff?",
        options: [
          "The result remains confirmed because cancellation reduction matters more than additional patient-message volume.",
          "Full success is not yet confirmed: investigate whether 22 percent more messages reflect confusion, useful support, or extra workload.",
          "Ignore the extra patient messages until next quarter because other effects often appear later than the main result.",
        ],
        correct: 1,
        answer: "TESTIMONY ACCEPTED: the increase needs investigation. Message counts alone do not establish confusion, harm, or unacceptable staff workload.",
        wrong: {
      ...
      },
      {
        ...
        glyph: "?",
        name: "The Verdict",
        clue: "Results met goal · new steps met goal · effects of extra messages still uncertain",
        ...
        options: [
          "Make the full workflow routine now because cancellations and checklist completion both met their targets.",
          "Investigate the extra messages and workload, then test any needed changes while keeping the five-day readiness check.",
          "Restart the entire improvement project because any increase in patient messages proves the original problem was chosen incorrectly.",
        ],
        correct: 1,
        answer: "TRIBUNAL COMPLETE: keep the readiness check that met its goal. Learn why messages increased, assess workload, and test any needed changes.",
        wrong: {
          0: "Two successful measures leave an unanswered question: are the extra messages helpful, confusing, or adding unacceptable work? Investigate before making the full process routine.",
          2: "The cancellation problem still matters, and readiness checks met their goal. Investigate the extra messages before deciding what needs to change.",
        },
      },
    ],
  },
  9: {
    ...
    prologue: [
      ...
      "One week also collapsed when the designated nurse was away. Share what helped, what surprised you, and what failed so another team can test the idea in its own clinic.",
    ],
    ...
    trials: [
      {
        ...
        clue: "Questions fell 34% · patients valued a clear callback path · the nurse had no backup",
