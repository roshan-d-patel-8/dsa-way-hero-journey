...
export const REMAINING_CHAMBER_SPECS: Record<RemainingBoxNumber, RemainingChamberSpec> = {
  ...
  6: {
    ...
    prologue: [
      "A chart review at an AFM clinic shows that 31% of patients leave follow-up visits without a printed next-step summary. The team proposes one end-of-visit checklist reminder in Health Connect: “Summary printed and handed to patient?” Nobody knows whether it will help—or slow checkout.",
    ...
    trials: [
      {
        ...
        options: [
          "Test the end-of-visit reminder with one physician, one assistant, and Tuesday morning’s ten visits.",
          "Deploy the new reminder to every AFM clinic for one month and compare averages.",
          "Discuss the reminder at committee and ask whether staff believe it could work.",
        ],
        correct: 0,
      ...
      },
      {
        ...
        options: [
          "If the reminder works, staff should feel that checkout is more organized and reliable.",
          "If used, at least nine of ten patients will leave with summaries and checkout adds under two minutes.",
      ...
      },
      {
        ...
        options: [
          "Record summary delivery, added checkout time, missed visits, interruptions, and workarounds for all ten encounters.",
      ...
      },
      {
        ...
        clue: "Prediction 9/10 · actual 8/10 · checkout +1.4 min · two break-coverage misses",
        prompt: "What is the scientifically honest next action?",
        coaching: "Adopt, adapt, or abandon—and what did the difference teach us?",
        options: [
          "Adopt across all sites because performance improved and added checkout time stayed under two minutes.",
          "Adapt break coverage, then repeat another ten-visit test during tomorrow’s morning clinic.",
          "Abandon the reminder because the first test missed the nine-of-ten prediction by one patient.",
        ],
        correct: 1,
    ...
    trials: [
      ...
      },
      {
        ...
        options: [
          ...
          "Sequence final checklist, translations, family validation, staff training, and then staged rollout.",
      ...
      },
      {
        ...
        options: [
          ...
          "Assign a monthly audit owner, publish correct-technique reliability, and define a response below 90 percent.",
