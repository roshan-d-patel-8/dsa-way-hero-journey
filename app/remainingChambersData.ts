...
export const REMAINING_CHAMBER_SPECS: Record<RemainingBoxNumber, RemainingChamberSpec> = {
  3: {
    ...
    prologue: [
      "The observatory is crowded with hopeful words: faster, easier, more patient-centered. Yet every telescope points into fog.",
      "Four stars must be fixed in the sky—magnitude, future process, balancing measure, and acceptance criteria—before the destination can guide anyone.",
    ],
    ...
    incantation: "Name how much. Name by when. Describe what we will see. Protect what must not worsen.",
    trials: [
      {
        id: "magnitude",
        glyph: "◎",
        name: "Magnitude & Date",
        clue: "Baseline: median review time 24 days · standard: 14 days",
        ...
        options: [
          ...
          "By November 30, reduce median referral-review time from 24 to 14 days or less.",
      ...
      },
      {
        ...
        options: [
          "At each weekday check, every new referral has one visible owner within four working hours.",
      ...
      },
      {
        ...
        options: [
          ...
          "Measure only median review time because additional indicators make the target unnecessarily complicated.",
        ],
        correct: 0,
      ...
      },
      {
        ...
        options: [
          ...
          "For eight consecutive weeks, median review is at most 14 days, ownership is visible, and after-hours work is unchanged.",
  ...
  5: {
    ...
    prologue: [
      "The armory offers more weapons than any hero could carry. Most are expensive. Several gleam. None has yet touched the lock.",
      "The lock was shaped by one verified condition: a shared queue with no explicit pull signal or ownership-transfer rule. Forge a set of modest keys from that shape.",
    ],
    ...
    trials: [
      {
        ...
        glyph: "⚿",
        name: "Root-Cause Fit",
        clue: "Verified cause: no pull signal or explicit ownership-transfer rule",
        ...
        options: [
          ...
          "Create a visible pull rule assigning the oldest unowned referral to the next available reviewer.",
          "Send weekly reminders asking reviewers to inspect the shared queue more frequently during each shift.",
        ],
        correct: 1,
        answer: "KEY FORGED: the pull rule directly counters ownerless work without assuming that more people or reminders are the answer.",
        wrong: {
          0: "Capacity may help a symptom, but the verified cause was not a shortage of coordinators. More people can still share an ownerless queue.",
      ...
      },
      {
        ...
        options: [
          "Test the pull rule, ownership flag, and twice-daily queue huddle as separate small countermeasures.",
        ...
        wrong: {
          1: "The brightest key has been selected before touching the lock. Technology can automate the same ownerless process.",
  ...
  6: {
    ...
    prologue: [
      "The laboratory has four stations and no grand rollout gate. One referral, one team, one morning can move the mechanism.",
      "Wind the cycle with a prediction, run the smallest safe test, study every surprise, and choose whether to adopt, adapt, or abandon.",
    ],
    ...
    trials: [
      ...
      },
      {
        ...
        options: [
          "If visible ownership works, staff should feel that the shared queue is more organized and fair.",
          "If the rule is used, median time to a named owner for ten referrals will fall below four hours.",
        ...
        wrong: {
          0: "Perception matters, but 'feel organized' cannot test whether ownership speed actually changed.",
  ...
  7: {
    ...
    prologue: [
      "Three rapid cycles have proven the ownership rule on one team. Now the road crosses four weeks, several clinics, and more hands than one hero can carry.",
      "Provision the expedition so every deliverable has an owner, every handoff has a sequence, every blocker has an escalation path, and the road remains patrolled after launch.",
    ],
    ...
    trials: [
      {
        ...
        options: [
          "Operations will finalize the ownership rule soon and distribute it when every participant is ready.",
          "Maya drafts the ownership standard by Friday; Luis validates urgent-referral exceptions on Monday.",
      ...
      },
      {
        ...
        options: [
          ...
          "Sequence owner rule, queue flag, exception validation, staff training, and then staged rollout.",
      ...
      },
      {
        ...
        options: [
          ...
          "Assign a monthly audit owner, publish reliability, and define response when ownership falls below 90 percent.",
  ...
  8: {
    ...
    prologue: [
      "The team returns to the dragon expecting surrender. Instead, the creature waits beside three scales: outcome, process, and harm elsewhere.",
      "The primary result improved. The ownership mechanism held. Yet a balancing measure moved in the wrong direction. Render an evidence-dependent verdict.",
    ],
    ...
    trials: [
      {
        ...
        clue: "Target ≤14 days for 8 weeks · actual 13 days for 8 weeks",
        ...
        options: [
          "Yes—the outcome met target: median review remained 13 days for eight consecutive weeks.",
          "No—the result cannot count until every referral is reviewed in exactly fourteen days.",
          "Yes—the rollout succeeded because staff completed training and the queue flag launched.",
        ],
        correct: 0,
      ...
      },
      {
        ...
        clue: "Visible ownership target ≥90% · actual 94%",
        ...
        options: [
          "The mechanism is supported: visible ownership reached 94 percent against the 90 percent reliability threshold.",
          "The mechanism is proven because review time improved after the ownership rule was launched.",
          "The mechanism failed because six percent of referrals still lacked visible ownership during audits.",
        ],
        correct: 0,
      ...
      },
      {
        ...
        options: [
          "The result remains confirmed because review time improved more than incomplete-return volume worsened.",
      ...
      },
      {
        ...
        options: [
          ...
          "Adapt completeness checks, run another bounded cycle, and preserve the ownership rule that worked.",
        ...
        wrong: {
          ...
          2: "The original access problem and ownership mechanism remain supported. The evidence calls for adaptation, not total restart.",
        },
      },
    ],
  },
  9: {
    ...
    prologue: [
      "At the summit, the team is not asked what it fixed. The final chamber asks what evidence changed its mind, what uncertainty felt like, and what it will carry into the next ascent.",
      "Distill the journey without polishing away failure. Then send the learning outward so another team can begin from higher ground.",
    ],
    ...
    trials: [
      {
        ...
        options: [
          ...
          "We learned visible ownership shortened review, while weak completeness checks shifted delay into rework.",
